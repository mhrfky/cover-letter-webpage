        ...
        <div className="mb-16">
          ...
          >
            <NarrativeCard
              ...
              description="Continuing my academic journey at one of Europe's top technical universities allowed me to specialize in cutting-edge technologies and research areas."
              color="#0f9d58"
              gif="/placeholder-tum.gif" // Replace with actual path when available
              caption="TUM campus"
            />
          </AnimatedElement>
        </div>
